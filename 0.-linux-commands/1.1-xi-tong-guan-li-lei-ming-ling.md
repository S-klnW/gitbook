...
如果希望服务器转发 GUI 界面时，需要额外添加-XY 参数。在 macOS 中开启 X11 转发服务可以参考

[#shi-yong-xquartz-diao-yong-gui-jie-mian](3.-mac-terminal.md#shi-yong-xquartz-diao-yong-gui-jie-mian "mention")章节内容。&#x20;
