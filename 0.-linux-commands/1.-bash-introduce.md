...
<table><thead><tr><th width="314">符号</th><th>作用</th></tr></thead><tbody><tr><td><code>command &#x3C; filename</code></td><td>将 <code>file</code> 作为 <code>command</code> 的标准输入。</td></tr><tr><td><code>command &#x3C;&#x3C; 分界符</code></td><td>从标准输入中读入，直到遇到分界符停止。</td></tr><tr><td><code>command &#x3C; filename1 > filename2</code></td><td>将 <code>file1</code> 作为命令的标准输入并将标准输出到 <code>file2</code>。</td></tr></tbody></table>

&#x20;**输出重定向符号**

<table><thead><tr><th width="292">符号</th><th>作用</th></tr></thead><tbody><tr><td><code>command > filename</code></td><td>将标准输出重定向到文件中。（清除原有文件中的数据）</td></tr><tr><td><code>command 2> filename</code></td><td>将错误输出重定向到文件中。（清除原有文件中的数据）</td></tr><tr><td><code>command >> filename</code></td><td>将标准输出重定向到文件中。（在原有的内容后追加）</td></tr><tr><td><code>command 2>> filename</code></td><td>将错误输出重定向到文件中。（在原有内容后面追加）</td></tr><tr><td><code>command >> filename 2>&#x26;1</code>或<code>command &#x26;>> filename</code></td><td>将标准输出和错误输出共同写入文件。</td></tr></tbody></table>
