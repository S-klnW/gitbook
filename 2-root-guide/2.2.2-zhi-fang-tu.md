...
<mark style="color:green;">当使用选项</mark> <mark style="color:green;"></mark><mark style="color:green;">`"SAME"`</mark> <mark style="color:green;"></mark><mark style="color:green;">绘制直方图时，ROOT 不会绘制新的统计框。强制绘制必须使用参数</mark> <mark style="color:green;"></mark><mark style="color:green;">`"SAMES"`</mark><mark style="color:green;">。</mark>如果新的统计框隐藏了前一个统计框，则可以使用以下行更改其位置（`"h"` 是指向直方图的指针）：
