...
在ROOT中，gStyle是用于设置全局绘图样式的类，它包含了一系列的成员函数来设置全局的绘图属性，包括填充颜色、线型、字体等。然而，在一些情况下，全局的gStyle设置可能会被局部的设置覆盖，导致gStyle的设置不生效。
...
#### **颜色：`SetMarkerColor()`，**参考[2.5.1](2.4.1-yan-se-shu-xing.md#ji-ben-yan-se)
