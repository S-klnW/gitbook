...
本页仅介绍一些基本属性，如 line、marker 的大小粗细等。其他属性设置如颜色、轴、文字等请参考：

{% content-ref url="2.4.1-tian-chong-shu-xing.md" %}
[2.4.1-tian-chong-shu-xing.md](2.4.1-tian-chong-shu-xing.md)
{% endcontent-ref %}

{% content-ref url="2.4.2-zuo-biao-zhou-shu-xing.md" %}
[2.4.2-zuo-biao-zhou-shu-xing.md](2.4.2-zuo-biao-zhou-shu-xing.md)
{% endcontent-ref %}
...
**颜色：`SetLineColor()`，参考**[**2.5.1**](2.4.1-tian-chong-shu-xing.md#ji-ben-yan-se)
...
#### **颜色：`SetMarkerColor()`，**参考[2.5.1](2.4.1-tian-chong-shu-xing.md#ji-ben-yan-se)
