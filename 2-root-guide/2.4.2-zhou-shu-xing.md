...
设置标题的函数是`GetX/Yaxis->SetTitle("name")`，也可以同时设置标题、x轴标题、y轴标题。用法是`SetTitle("graph tittle; x tittle; y tilttle")`
...
颜色：无效TStyle::SetFrameFillColor

样式：无效 TStyle::SetFrameFillStyle

颜色：无效TStyle::SetFrameLineColor

无效 TStyle::SetFrameLineStyle
