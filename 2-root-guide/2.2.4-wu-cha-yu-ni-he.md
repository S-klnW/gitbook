...
<table data-header-hidden><thead><tr><th width="112">字符串</th><th width="201">对应数学模型</th><th>适用物理场景</th></tr></thead><tbody><tr><td><code>"gaus"</code></td><td>高斯分布</td><td>测量误差分析、能谱中的光电峰/信号峰拟合</td></tr><tr><td><code>"expo"</code></td><td>指数衰减</td><td>放射性核素衰减、宇宙线 <span class="math">μ</span>子 寿命测量、本底估计</td></tr><tr><td><code>"polN"</code></td><td>N 阶多项式（如 <code>"pol2"</code>、<code>"pol3"</code>）</td><td>复杂的连续谱本底（Background）平滑拟合</td></tr><tr><td><code>"landau"</code></td><td>朗道分布</td><td>带电粒子穿过薄探测器（如硅微条、气体正比计数器）的电离能量损失（<span class="math">dE/dx</span>）拟合</td></tr></tbody></table>
