...
{% content-ref url="2.2.1-zhi-fang-tu.md" %}
[2.2.1-zhi-fang-tu.md](2.2.1-zhi-fang-tu.md)
{% endcontent-ref %}

{% content-ref url="2.2.2-han-shu-yu-tu-xing.md" %}
[2.2.2-han-shu-yu-tu-xing.md](2.2.2-han-shu-yu-tu-xing.md)
{% endcontent-ref %}
...
最基本的分析方法是使用由两个 ( [`TGraph`](https://root.cern/doc/master/classTGraph.html)) 或三个 ( [`TGraph2D`](https://root.cern/doc/master/classTGraph2D.html)) 数组组成的坐标表示数值大小或位置，称作 Graph 。这与直方图不同。

ROOT 提供了许多图形类：

* **XY图**

[TGraph](https://root.cern/doc/master/classTGraph.html)：图表。

[TGraphErrors](https://root.cern/doc/master/classTGraphErrors.html)：具有对称误差线的图表。

[TGraphAsymmErrors](https://root.cern/doc/master/classTGraphAsymmErrors.html)：具有不对称误差线的图表。

[TGraphBentErrors](https://root.cern/doc/master/classTGraphBentErrors.html)：[`TGraph`](https://root.cern/doc/master/classTGraph.html)具有弯曲、不对称误差线的A。

[TGraphMultiErrors](https://root.cern/doc/master/classTGraphMultiErrors.html)：[`TGraph`](https://root.cern/doc/master/classTGraph.html)具有不对称误差线和多个 y 误差维度的A。

[TGraphPolar](https://root.cern/doc/master/classTGraphPolar.html)：[`TGraphErrors`](https://root.cern/doc/master/classTGraphErrors.html)以极坐标表示的A。

[TGraphQQ](https://root.cern/doc/master/classTGraphQQ.html)：绘制分位数-分位数图。

[TMultiGraph](https://root.cern/doc/master/classTMultiGraph.html)[`TGraph`](https://root.cern/doc/master/classTGraph.html) ：（或派生）对象的集合。

* **XYZ 图表**

[TGraph2D](https://root.cern/doc/master/classTGraph2D.html)：由三个数组 X、Y 和 Z 组成的图，每个数组的点数相同。

[TGraph2DErrors](https://root.cern/doc/master/classTGraph2DErrors.html)：[`TGraph2D`](https://root.cern/doc/master/classTGraph2D.html)带有误差线的A。
...
常常，坐标点的数据会被输出到一个文本文件中，方便查看和保存。快速绘制该文件的坐标使用`TGraph`绘制，<mark style="color:red;">这里要求文件中的坐标中间是空格或者制表符，不可以是逗号。</mark>
...
<figure><img src="../.gitbook/assets/test.png" alt="" width="375"><figcaption><p>具有带宽的函数图案</p></figcaption></figure>
...
{% content-ref url="2.1-shu-ju-chu-li.md" %}
[2.1-shu-ju-chu-li.md](2.1-shu-ju-chu-li.md)
{% endcontent-ref %}
