...
**颜色：**`SetTitleColor()`参考[2.5.1](2.6.1-yan-se-shu-xing-tcolor.md#ji-ben-yan-se)

**大小：**`SetTitleSize()`

**字体：**`SetTextFont()`参考[2.5.](2.6.3-wen-zi-shu-xing-tlatex.md#zi-ti)3
...
**字体：**`SetTextFont()`参考[2.5.2](2.6.3-wen-zi-shu-xing-tlatex.md#zi-ti)
