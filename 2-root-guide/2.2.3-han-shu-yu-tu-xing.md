...
* `sqrt2`、`e`、`pi`、`ln10`、`infinity` 等。e.g.
...
```bash
root [1] auto fa1 = new TF1("fa1","sin(x)/x",0,10)
(TF1 *) 0x131e9e110
root [2] fa1->Draw()
...
<summary>e.g. 仿 Python 风格的绘图</summary>
...
**参考：**[classTArrow](https://root.cern/doc/master/classTArrow.html)
...
`TEllipse` 是很强大的类，它能帮你绘制椭圆、圆、半圆、倾斜的椭圆等，其标准用如下：
...
* 等高线绘法：[https://root-forum.cern.ch/t/th2d-contour-lines/19860](https://root-forum.cern.ch/t/th2d-contour-lines/19860)
* 经纬度绘法：[https://root-forum.cern.ch/t/problem-drawing-aitoff-and-tgraph-together/6498/3](https://root-forum.cern.ch/t/problem-drawing-aitoff-and-tgraph-together/6498/3)
