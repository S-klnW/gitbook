...
**颜色：`SetLineColor()`，参考**[**2.5.1**](2.6-shu-xing-she-zhi-tatt/2.6.1-yan-se-shu-xing-tcolor.md#ji-ben-yan-se)
...
#### **颜色：`SetMarkerColor()`，**参考[2.5.1](2.6-shu-xing-she-zhi-tatt/2.6.1-yan-se-shu-xing-tcolor.md#ji-ben-yan-se)
