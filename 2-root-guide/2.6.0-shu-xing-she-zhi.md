...
ROOT 的 gStyle 类是用于定义绘图风格的类，它包含了绘图元素的各种属性设置，如线条颜色、线条宽度、填充颜色、字体样式等，从而创建出符合需求的图形效果。通过 gStyle 类，用户可以轻松地实现图形的定制化，使得绘制的图形更加美观和易于理解。
...
本页仅介绍一些基本属性，如line、marker的大小粗细等。其他属性设置如颜色、轴、文字等请参考：

{% content-ref url="2.6.1-yan-se-shu-xing.md" %}
[2.6.1-yan-se-shu-xing.md](2.6.1-yan-se-shu-xing.md)
{% endcontent-ref %}

{% content-ref url="2.6.2-zhou-shu-xing.md" %}
[2.6.2-zhou-shu-xing.md](2.6.2-zhou-shu-xing.md)
{% endcontent-ref %}

{% content-ref url="2.6.3-wen-zi-shu-xing.md" %}
[2.6.3-wen-zi-shu-xing.md](2.6.3-wen-zi-shu-xing.md)
{% endcontent-ref %}
...
**颜色：`SetLineColor()`，参考**[**2.5.1**](2.6.1-yan-se-shu-xing.md#ji-ben-yan-se)
...
#### **颜色：`SetMarkerColor()`，**参考[2.5.1](2.6.1-yan-se-shu-xing.md#ji-ben-yan-se)
