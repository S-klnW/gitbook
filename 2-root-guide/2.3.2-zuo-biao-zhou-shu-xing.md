...
`gStyle->SetFrameLineColor(Color_t color)`、`SetFrameLineStyle(Style_t style)`、`gStyle->SetFrameFillColor(Color_t color)`、`gStyle->SetFrameFillStyle(Style_t style)`：颜色与风格，参数参考：

[2.3-shu-xing-she-zhi.md](2.3-shu-xing-she-zhi.md "mention")
...
<mark style="color:green;">对数轴是</mark> <mark style="color:green;"></mark><mark style="color:green;">`Tcanvas`</mark> <mark style="color:green;"></mark><mark style="color:green;">的类，所以设置对数轴，需要先建立画布。</mark>
...
参考[极坐标图案](2.2-shu-ju-ke-shi-hua.md#ji-zuo-biao-tu-an-graphpolar)
