...
`gStyle->SetFrameLineColor(Color_t color)`、`SetFrameLineStyle(Style_t style)`、`gStyle->SetFrameFillColor(Color_t color)`、`gStyle->SetFrameFillStyle(Style_t style)`：颜色与风格，参数参考：[2.3-shu-xing-she-zhi.md](2.3-shu-xing-she-zhi.md "mention")
