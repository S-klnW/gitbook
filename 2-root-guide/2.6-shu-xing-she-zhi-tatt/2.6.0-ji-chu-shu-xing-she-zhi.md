...
**颜色：`SetLineColor()`，参考**[**2.5.1**](../../2.-root-guide/2.5.1-se-cai-shu-xing-tcolor.md#ji-ben-yan-se)
...
#### **颜色：`SetMarkerColor()`，**参考[2.5.1](../../2.-root-guide/2.5.1-se-cai-shu-xing-tcolor.md#ji-ben-yan-se)
