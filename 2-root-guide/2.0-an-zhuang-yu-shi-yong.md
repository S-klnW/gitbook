...
ROOT 是 CERN 开发的科学分析 PB级数据的强大工具，用户可通过[ROOT官网](https://root.cern.ch)和[查阅手册](2.0-an-zhuang-yu-shi-yong.md#root-jiao-cheng-ji-he)来学习。
...
<summary>E.g. 画布连续保存到一个 PDF 文件中</summary>
