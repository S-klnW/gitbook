...
由 CERN 开发的科学分析 PB 级数据的强大工具 ROOT 已经成为最著名的开源数据分析框架之一，支持 C 与 python 语言，用户可通过[ROOT官网](https://root.cern.ch)和[查阅手册](2.0-an-zhuang-yu-shi-yong.md#root-jiao-cheng-ji-he)来学习使用。
