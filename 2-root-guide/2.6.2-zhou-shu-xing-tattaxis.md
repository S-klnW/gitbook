...
**颜色：**`SetTitleColor()`参考[2.5.1](2.6.1-yan-se-shu-xing-tattcolor.md#ji-ben-yan-se)

**大小：**`SetTitleSize()`

**字体：**`SetTextFont()`参考[2.5.](2.6.3-wen-zi-shu-xing-tatttext-tlatex.md#zi-ti)3
...
**字体：**`SetTextFont()`参考[2.5.2](2.6.3-wen-zi-shu-xing-tatttext-tlatex.md#zi-ti)
...
参考2.3节图形的[绘图选项](../2.-root-guide/2.3.-tu-biao-graphs.md#tu-xing-de-hui-tu-xuan-xiang)
...
参考2.3节图形的[极坐标图案](../2.-root-guide/2.3.-tu-biao-graphs.md#ji-zuo-biao-tu-an-graphpolar)
