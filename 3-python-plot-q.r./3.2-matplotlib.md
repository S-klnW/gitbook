...
ax2.plot(theta, r, color='royalblue')
ax2.set_title("1. Polar")
...
ax3.plot(np.sin(theta), np.cos(theta), z, color='darkgreen')
ax3.set_title("3. 3D Plot")

# Aitoff
ax4 = fig.add_subplot(2, 3, 4, projection='aitoff')
ax4.plot(x, y, color='purple')
ax4.grid(True)
ax4.set_title("4. Aitoff")

# Hammer
ax5 = fig.add_subplot(2, 3, 5, projection='hammer')
ax5.plot(x, y, color='orange')
ax5.grid(True)
ax5.set_title("5. Hammer")

# Mollweide
ax6 = fig.add_subplot(2, 3, 6, projection='mollweide')
ax6.plot(x, y, color='teal')
ax6.grid(True)
ax6.set_title("6. Mollweide")
...
<figure><img src="../.gitbook/assets/project.svg" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../.gitbook/assets/anatomy.svg" alt=""><figcaption></figcaption></figure>
