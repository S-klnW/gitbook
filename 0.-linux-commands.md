...
**top命令** 可以实时动态地查看系统的整体运行情况，是一个综合了多方信息监测系统性能和运行信息的实用工具。个性化 **top** 界面：

<mark style="background-color:orange;">运行</mark> <mark style="background-color:orange;"></mark><mark style="background-color:orange;">`top`</mark> <mark style="background-color:orange;"></mark><mark style="background-color:orange;">之后（也可按</mark><mark style="background-color:orange;">`z`</mark><mark style="background-color:orange;">更改界面颜色）按</mark> <mark style="background-color:orange;"></mark><mark style="background-color:orange;">`shift+z`</mark><mark style="background-color:orange;">，依次点按</mark><mark style="background-color:orange;">`S`</mark><mark style="background-color:orange;">和数字</mark><mark style="background-color:orange;">`0-7`</mark><mark style="background-color:orange;">可以更改对应位置的字体颜色，按</mark><mark style="background-color:orange;">`t`</mark><mark style="background-color:orange;">和</mark><mark style="background-color:orange;">`m`</mark><mark style="background-color:orange;">可以切换显示CPU、GPU的占用情况，按回车后按</mark><mark style="background-color:orange;">`W`</mark><mark style="background-color:orange;">保存。</mark>
