...
<table><thead><tr><th width="109">符号</th><th></th></tr></thead><tbody><tr><td>.</td><td>匹配除换行符以外的任意单个字符</td></tr><tr><td>*</td><td>匹配任何字符</td></tr><tr><td>?</td><td>匹配单个字符</td></tr><tr><td>[]</td><td>多范围匹配，</td></tr><tr><td>{}</td><td>多选项匹配，</td></tr><tr><td>/</td><td>转义字符，转为表达字符的原始含义用，</td></tr><tr><td>^</td><td>取反匹配，</td></tr></tbody></table>
