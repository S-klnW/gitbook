...
_<mark style="color:red;">**当你想要在登录时**</mark><mark style="color:red;">**`echo`**</mark><mark style="color:red;">**一些个性化的内容（如登录信息，一首小诗），应该将你的脚本添加在**</mark><mark style="color:red;">**`$HOME/.bash_profile`**</mark><mark style="color:red;">**中，不得添加在**</mark>**`$HOME/.bashrc`****中**<mark style="color:red;">**，因为在使用**</mark><mark style="color:red;">**`sfp`**</mark><mark style="color:red;">**等需要按行查看登录环境的命令时，你的**</mark><mark style="color:red;">**`echo`**</mark><mark style="color:red;">**命令会打乱其读取的内容，导致连接失败。**</mark>_
