...
<table><thead><tr><th width="109">符号</th><th></th></tr></thead><tbody><tr><td>.</td><td></td></tr><tr><td>*</td><td></td></tr><tr><td>[]</td><td></td></tr><tr><td>{}</td><td></td></tr><tr><td>/</td><td></td></tr><tr><td></td><td><pre><code>. : 匹配除换行符之外的任意单个字符
* : 匹配千导字符的任意个数
[]: 某组字符串的任意一个字符
[^] : 取反
[a-z]  : 匹配小写字母
