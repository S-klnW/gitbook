...
**颜色：`SetLineColor()`，参考**[**2.5.1**](2.5.1-yan-se-she-zhi-tcolor.md#ji-ben-yan-se)
...
#### **颜色：`SetMarkerColor()`，**参考[2.5.1](2.5.1-yan-se-she-zhi-tcolor.md#ji-ben-yan-se)
...
**颜色：**`SetTitleColor()`参考[2.5.1](2.5.1-yan-se-she-zhi-tcolor.md#ji-ben-yan-se)

**大小：**`SetTitleSize()`

**字体：**`SetTextFont()`参考[2.5.2](2.5.3-wen-zi-yu-shu-xue-gong-shi-tlatex.md#zi-ti)
