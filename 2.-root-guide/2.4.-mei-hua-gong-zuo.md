...
线的属性通常包含[颜色](2.5.-se-cai-she-zhi-tcolor.md#ji-ben-yan-se)、宽度、风格，可以分别通过下面的命令来分别设置：
...
root中记号的属性通常包含[颜色](2.5.-se-cai-she-zhi-tcolor.md#ji-ben-yan-se)、大小、风格，可以分别通过下面的命令来分别设置：
...
<figure><img src="../.gitbook/assets/截屏2023-10-24 16.40.36.png" alt=""><figcaption></figcaption></figure>
...
在绘图时应小心使用非对称符号。 这个图表显示了粗心大意使用符号是多么具有误导性！这两个绘图代表相同的数据集，但由于符号选择不当，顶部的两个绘图看起来比底部示例相距更远。
{% endhint %}

<figure><img src="../.gitbook/assets/截屏2023-10-24 16.38.19.png" alt="" width="375"><figcaption></figcaption></figure>
