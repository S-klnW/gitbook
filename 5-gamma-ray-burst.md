...
$$T_{90}$$是指探测器接收到总能量的**5%**到总能量的**95%**所经过的时间（亦或累计接收到的光子数从总接收的光子数的**5%\~95%**的时间间隔）。
...
<mark style="color:blue;background-color:blue;">**伽玛暴距离的重要性在于需要借助它来确定伽玛暴爆发的总能量释放**</mark>：如果伽玛暴是银河系尺度，伽玛暴的各向同性能量将小于$$10^{37}J$$；而如果是宇宙学起源，爆发的总能量将高达$$10^{46}J$$，远远超过了超新星爆发时的总能量。**伽马暴的距离观测直接证据来自于伽马暴的余辉。**
